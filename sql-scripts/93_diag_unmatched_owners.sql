...
-- ============================================================
SELECT '1' AS "מס׳", 'מילוסבסקי' AS "מחפש", owner_name, id_number, agreement_area
...
-- ============================================================
SELECT '2' AS "מס׳", 'דוד היימן' AS "מחפש", owner_name, id_number, agreement_area
FROM public.signed_owners
...
-- ============================================================
SELECT '3' AS "מס׳", 'בן דו(י)ד' AS "מחפש", owner_name, id_number, agreement_area
FROM public.signed_owners
...
-- ============================================================
SELECT '4-5' AS "מס׳", 'זי(י)גרמן' AS "מחפש", owner_name, id_number, agreement_area
FROM public.signed_owners
...
-- 6. עירית יוחננוף
-- ============================================================
SELECT '6' AS "מס׳", 'יוחננוף' AS "מחפש", owner_name, id_number, agreement_area
FROM public.signed_owners
...
-- ============================================================
SELECT '7' AS "מס׳", 'יניר פלדמן' AS "מחפש", owner_name, id_number, agreement_area
FROM public.signed_owners
...
-- ============================================================
SELECT '8' AS "מס׳", 'חייט' AS "מחפש", owner_name, id_number, agreement_area
FROM public.signed_owners
...
-- 9. מאירה דניאלה זלץ
-- ============================================================
SELECT '9' AS "מס׳", 'זלץ' AS "מחפש", owner_name, id_number, agreement_area
FROM public.signed_owners
...
-- 10. מירה יצחקי
-- ============================================================
SELECT '10' AS "מס׳", 'מירה יצחקי' AS "מחפש", owner_name, id_number, agreement_area
FROM public.signed_owners
...
-- ============================================================
SELECT '11' AS "מס׳", 'מרקוויץ/מרקוביץ' AS "מחפש", owner_name, id_number, agreement_area
FROM public.signed_owners
...
-- ============================================================
SELECT '12' AS "מס׳", 'שטיין' AS "מחפש", owner_name, id_number, agreement_area
FROM public.signed_owners
...
-- ============================================================
SELECT '13' AS "מס׳", 'כץ' AS "מחפש", owner_name, id_number, agreement_area
FROM public.signed_owners
...
-- ============================================================
SELECT '14' AS "מס׳", 'ונטורה' AS "מחפש", owner_name, id_number, agreement_area
FROM public.signed_owners
...
-- 15. יהודית בטינה
-- ============================================================
SELECT '15' AS "מס׳", 'בטינה' AS "מחפש", owner_name, id_number, agreement_area
FROM public.signed_owners
...
-- ============================================================
SELECT '16-17' AS "מס׳", 'פרסט/תנפלד' AS "מחפש", owner_name, id_number, agreement_area
FROM public.signed_owners
...
-- ============================================================
SELECT '18' AS "מס׳", 'חכמון/ינקו' AS "מחפש", owner_name, id_number, agreement_area
FROM public.signed_owners
...
-- ============================================================
SELECT '19' AS "מס׳", 'שריקר' AS "מחפש", owner_name, id_number, agreement_area
FROM public.signed_owners
...
-- ============================================================
SELECT '20' AS "מס׳", 'סולומון/ספיר' AS "מחפש", owner_name, id_number, agreement_area
FROM public.signed_owners
...
-- ============================================================
SELECT '21' AS "מס׳", 'הוכברג' AS "מחפש", owner_name, id_number, agreement_area
FROM public.signed_owners
...
-- ============================================================
SELECT '22-23' AS "מס׳", 'מילט' AS "מחפש", owner_name, id_number, agreement_area
FROM public.signed_owners
WHERE owner_name ILIKE '%מילט%' AND is_active = TRUE;

SELECT '24-25' AS "מס׳", 'דניאלי' AS "מחפש", owner_name, id_number, agreement_area
FROM public.signed_owners
...
SELECT '26' AS "מס׳", 'שביט' AS "מחפש", owner_name, id_number, agreement_area
FROM public.signed_owners
WHERE owner_name ILIKE '%שביט%' AND is_active = TRUE;

-- 27. משה ילובסקי
SELECT '27' AS "מס׳", 'ילובסקי' AS "מחפש", owner_name, id_number, agreement_area
FROM public.signed_owners
WHERE owner_name ILIKE '%ילובסקי%' AND is_active = TRUE;

-- 28. רוחמה צלליכין
SELECT '28' AS "מס׳", 'צלליכין' AS "מחפש", owner_name, id_number, agreement_area
FROM public.signed_owners
WHERE owner_name ILIKE '%צלליכין%' AND is_active = TRUE;

-- 29. כל מי שיש בו "ברקוביץ"
SELECT '29' AS "מס׳", 'ברקוביץ' AS "מחפש", owner_name, id_number, agreement_area
FROM public.signed_owners
